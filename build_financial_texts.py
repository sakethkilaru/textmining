...
for t in TICKERS:
    ...
    lines = []
    lines.append(f"{name} ({t}) is a company in the {sector} sector and {industry} industry based in {country}.")
    lines.append(f"As of the latest data snapshot used in this project, the market cap of {name} was {market_cap}.")
    lines.append(f"The company generated total revenue of {total_revenue} over the trailing twelve months.")
    lines.append(f"Its profit margin was {profit_margin}, operating margin was {op_margin}, and gross margin was {gross_margin}.")
